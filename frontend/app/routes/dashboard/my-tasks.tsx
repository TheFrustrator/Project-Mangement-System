...
import { useGetMyTaskQuery } from "@/hooks/use-task";
...
const MyTask = () => {
  ...
  const { data: myTasks, isLoading } = useGetMyTaskQuery() as {
    data: Task[];
    isLoading: boolean;
  };
                  ...
                  <div key={task._id} className="p-4 hover:bg-muted/50">
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-2 gap-3">
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-2 mt-1">
                            ...
                            {task.isArchived && (
                              <Badge variant={"outline"}>Archieved</Badge>
                            )}
                          </div>
                        </div>
                      </div>
                      <div className="text-sm text-muted-foreground space-y-1">
                        ...
                        <div>Notify on: {format(task.updatedAt, "PPPP")}</div>
                      </div>
                    </div>
                  </div>
                ))}
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center mt-2 gap-2">
                        ...
                        {task.dueDate && (
                          <span className="text-sm text-muted-foreground">{format(task.dueDate, "PPPP")}</span>
                        )}
                      </div>
                    </Link>
                  </Card>
